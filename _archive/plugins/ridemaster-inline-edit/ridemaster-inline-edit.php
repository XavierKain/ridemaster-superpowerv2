<?php
/**
 * Plugin Name: RideMaster Inline Edit
 * Description: Inline editing for coach profiles and camp products on the frontend. Coaches can edit visually without a form.
 * Version: 3.1.5
 * Author: RideMaster
 * Text Domain: ridemaster-inline-edit
 */
...
class RM_Inline_Edit {
	...
	private function do_enqueue_assets() {
		...
		wp_enqueue_style(
			'rm-inline-edit',
			plugin_dir_url( __FILE__ ) . 'assets/css/inline-edit.css',
			[],
			'3.1.5'
		);
